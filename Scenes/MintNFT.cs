...
public class MintNFT : MonoBehaviour
{
    ...
    public async void MintNft()
    {
        ...
        var provider = new JsonRpcProvider("https://goerli.infura.io/v3/ADD_INFURA_KEY");
        var value = "0";
        ...
        var playerAccount = PlayerPrefs.GetString("Account");
        var gasLimit = "";
        var gasPrice = "";
...
#endif
#if UNITY_WEBGL
        var responseWeb = await Web3GL.SendTransactionData(contractAddress, value, gasPrice, gasLimit, calldata);
#endif
    }
